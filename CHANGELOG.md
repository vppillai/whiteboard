...
- **Select tool integrates shapes** as a first-class kind. Move / resize / rotate / multi-select / marquee / delete all work the same as for images / texts; the contextual menu picks up a Color / Stroke width / Fill row when a single shape is selected.
