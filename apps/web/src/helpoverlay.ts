...
const SHORTCUTS = [
  ...
  'S                  tool: lasso',
  'V                  tool: select  (images / texts / strokes — click to select)',
  ...
  '⌘/Ctrl + C / X     copy / cut: lasso → PNG · selected image → bytes',
  '⌘/Ctrl + V         paste image (PNG/JPG/WebP/GIF) or clipboard text → TextObject',
  'Delete             delete selection (lasso / Select tool / Cmd+A batch · also Backspace)',
